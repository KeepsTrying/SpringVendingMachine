...
<%-- 
    Document   : successAndChange
    Created on : Jul 2, 2017, 1:42:48 PM
    Author     : apprentice
--%>
        ...
        <div class="col-sm-3" id="formDisplay">
            ...
            <form class="form" role="form" id="purchaseForm"
                ...
                <div class="row" id="messageBox">
                    <p>Thank You! Enjoy your <c:out value="${name}"/>!</p>
                </div>
            ...
            <div class="form" role="form" id="changeForm">
                ...
                <div class="form-group row" 
                    ...
                    Dollars: <c:out value="${change.dollars}"/><br/>
                    Quarters: <c:out value="${change.quarters}"/><br/>
                    Dimes: <c:out value="${change.dimes}"/><br/>
                    Nickels: <c:out value="${change.nickels}"/><br/>
                </div>
